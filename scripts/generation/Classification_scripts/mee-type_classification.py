...
type_path = './data/mee-type_synthetic/'
file_list = ['mee-type_ddpm_quantileUni_lda_5.csv', 'mee-type_flow_quantileUni_lda_100.csv', 'mee-type_flow_quantileUni_lda_1000.csv', 'mee-type_flow_quantileUni_lda_10000.csv', 'mee-type_gan_quantileUni_lda_100.csv', 'mee-type_gan_quantileUni_lda_1000.csv', 'mee-type_gan_quantileUni_lda_10000.csv', 'mee-type_smote_quantileUni_lda_1000.csv', 'mee-type_smote_quantileUni_lda_2000.csv', 'mee-type_smote_quantileUni_lda_5000.csv', 'mee-type_smote_quantileUni_lda_10000.csv', 'mee-type_vae_quantileUni_lda_5.csv']

X_test = pd.read_csv(file_path + 'X_test_mee.csv')
y_test = pd.read_csv(file_path + 'y_test_mee.csv').values.ravel()

quantile_u = QuantileTransformer(n_quantiles=1000, output_distribution="uniform")
X_test_scaled = quantile_u.fit_transform(X_test)
...
temp_output_path = '../mee_results_temp.csv'
...
summary_df.to_csv('../mee_results.csv', index=False)
