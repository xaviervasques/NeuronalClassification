...
# List of scalers, reducers, and classifiers
scalers = {
    'minmax': MinMaxScaler(),
...
reducers = {
    ...
    'modified_lle': LocallyLinearEmbedding(n_components=2, method="modified"),
    'hessian_lle': LocallyLinearEmbedding(n_components=2, method="hessian"),
    'ltsa_lle': LocallyLinearEmbedding(n_components=2, method="ltsa"),
    'mds': MDS(n_components=2, n_init=1, max_iter=120, n_jobs=2),
    'tnse': TSNE(n_components=2, init="pca", learning_rate="auto", n_iter=500, n_iter_without_progress=150, n_jobs=2),
    ...
    for reducer_name, reducer in reducers.items():
        for classifier_name, classifier in classifiers.items():
            try:
                ...
                all_results['reducer'] = reducer_name
                ...
                print(f"Results after {scaler_name}, {reducer_name}, {classifier_name}:")
                print(all_results.head())
            except Exception as e:
                print(f"Error with {scaler_name}, {reducer_name}, {classifier_name}: {e}")
