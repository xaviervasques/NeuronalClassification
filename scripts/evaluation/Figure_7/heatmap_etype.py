...
df_synth = pd.read_csv("e-type_smote_maxabs_5000.csv", delimiter=",")
...
plt.title("Feature mean profiles by e-type", fontsize=40)
plt.ylabel("e-type - Train, Test, Synthetic", fontsize=22)
...
plt.title('Distance between synthetic and real mean profiles (by e-type)', fontsize=22)
plt.legend()
plt.tight_layout()
...
plt.title("Mean absolute error (synthetic vs train) per feature and e-type", fontsize=22)
plt.xlabel("Feature", fontsize=22)
plt.ylabel("e-type", fontsize=22)
plt.tight_layout()
...
plt.title("Mean absolute error (synthetic vs test) per feature and e-type", fontsize=22)
plt.xlabel("Feature", fontsize=22)
plt.ylabel("e-type", fontsize=22)
plt.tight_layout()
